...
<style>
    ...
    <meta charset=utf-8 />
    <title>BGH - POS Collection(IPD+OPD)</title>
  </head>
  <body>
...
<nav class="navbar navbar-dark fixed-top bg-warning">
 <a class="navbar-brand" href="bgh_main.php"><img src="sail-logo.jpg" width="40" height="40" alt="BGH-MAIN"></a> 
  <h6>BGH All POS Collection</h6>
<div class="container">
<form  class="form-inline" name="myform" action="bgh_allpos_collection.php" method="POST"> <input type="hidden" name="check_submit" value="1" />     
...
//                  where to_char(admdate,'YYYY-MM-DD') between :EIDBV and :EIDBV1 order by hospno";
        ...
        $query = "select to_char(rrn_date,'YYYY-MM') , sum(total_amt)  
                from BGH_POS_DAILY_DATE_VIEW
                where to_char(rrn_date,'YYYY-MM-DD') between :EIDBV and :EIDBV1
                group by to_char(rrn_date,'YYYY-MM')
                order by to_char(rrn_date,'YYYY-MM')";                
