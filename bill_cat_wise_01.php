...
<div class="container">
<form  class="form-inline" name="myform" action="bill_cat_wise_01.php" method="POST"> <input type="hidden" name="check_submit" value="1" />     
...
//                        }
        ...
        $query = "select hospcg, name party_name, sum(bill_grand_total) total_bill from view_wardbill_rgstrpat_01
                  where to_char(hbilldt,'YYYY-MM-DD') between :EIDBV and :EIDBV2 group by hospcg, name 
