...
<form  class="form-inline" name="myform" action="ward_nl_trend.php" method="POST"> <input type="hidden" name="check_submit" value="1" />     
      <h3> WARD LOCAL PURCHASE Not Listed  MEDICINES </h3>
