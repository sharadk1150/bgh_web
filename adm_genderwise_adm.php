...
.navbar-expand{-sm|-md|-lg|-xl}
 ...
 <nav class="navbar navbar-dark fixed-top bg-warning">
  <h6>IPD Gender Wise Admission</h6>
<div class="container">
<form  class="form-inline" name="myform" action="adm_genderwise_adm.php" method="POST">
                <input type="hidden" name="check_submit" value="1" />
    <form class="form-inline">   
        <div class="form-group row">
            <label for="stdate" class="mr-sm-3 col-form-label">Gender Wise Admission From Date</label> 
                <div class="mr-sm-3">
