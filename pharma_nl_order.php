...
<html>
<head>
  <title>Pharma: NL Medicines</title>
...
//            date("d/m/Y", strtotime($str));
                ...
                print '<tr>'; 
                print '<td colspan="9">' . 'NL Medicines From : ' . date("d-m-Y", strtotime($myeid)) .  '  To Date : ' . date("d-m-Y", strtotime($myendt)) . '</td>';
                print '</tr>';
                print '<tr>';
