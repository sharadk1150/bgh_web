...
//              print '<table class="table table-sm table-bordered table-striped table-dark w-auto table-hover">';   
                print '<table class="table table-hover table-striped table-bordered mydatatable" style="width:100%">'; 
                    ...
                    print '<th scope="col">All Ctr Stock</th>';
                    print '<th scope="col">Med Group</th>';
                    print '<th scope="col">MinLevel</th>';
                    print '</tr>';
                    print '</thead>';
        ...
        $query = "select drug_code, med_gen_name, bname, unit, all_ctr_stock, med_group, minlevel from pharma_allctr_stock_view order by med_gen_name";    
