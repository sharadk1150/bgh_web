...
<nav class="navbar navbar-dark fixed-top bg-warning">
 <a class="navbar-brand" href="bgh_main.php"><img src="sail-logo.jpg" width="40" height="40" alt="BGH-MAIN"></a> 
  <h6>BGH IPD Third Party Billing</h6>
<div class="container">
<form  class="form-inline" name="myform" action="bill_cat_wise_03.php" method="POST"> <input type="hidden" name="check_submit" value="1" />     
