...
#con=cx_Oracle.connect('SYSTEM/sbls23194@localhost')
...
def insert():
 ...
 mycur.executemany("insert into customers(cust_no,cust_name,cust_age,cust_gen,cust_ph,cust_email,cust_add) values(:1,:2,:3,:4,:5,:6,:7)",new)
 con.commit()
