...
<html>
<head>
  <title>Medicne Issued For CSR: Sarwa Swasthya Kendra HC-5 </title>
...
<nav class="navbar navbar-dark fixed-top bg-warning">
 <a class="navbar-brand" href="bgh_main.php"><img src="sail-logo.jpg" width="40" height="40" alt="BGH-MAIN"></a> 
  <h6>Medicine Issue To CSR-20</h6>
<div class="container">
<form  class="form-inline" name="myform" action="medissue_csr_20.php" method="POST"> <input type="hidden" name="check_submit" value="1" />     
...
// print the total value of the medicine issued to the CSR Counter  
                ...
                {            
                    print '<b>' . 'Total Value of Medicine Issued to CSR SSK is Rs.: ' . $row_1["TOT_VALUE"] . '</b>';
                }                        
                print '</tr>';
...
// Print the data in Table            
        ...
        where ctrno = '13' and to_char(issue_dt,'YYYY-MM-DD') between :EIDBV and :EIDBV2 
